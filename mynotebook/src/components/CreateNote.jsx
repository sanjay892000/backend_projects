...
const CreateNote = () => {
    ...
    const addNoteFun = (e) => {
        e.preventDefault();
        addNotes(notes.title, notes.description, notes.tag, image)
    ...
    return (
        <div className='flex px-6 flex-col items-center pb-16 bg-gray-100'>
            ...
            <form className="mt-6 w-1/2 max-lg:w-full mb-0 space-y-4 rounded-lg p-4 shadow-sm sm:p-6 lg:p-8" onSubmit={addNoteFun}>
                ...
                <fieldset className="w-full space-y-1 dark:text-gray-800">
                    ...
                    <div className="flex">
                        <input type="file" name="files" id="files" className="px-3 py-6 border-2 border-dashed rounded-md dark:border-gray-300 dark:text-gray-600 dark:bg-gray-100" onChange={(e) => { setImage(e.target.files[0]) }} />
                    </div>
                </fieldset>
