            ...
            <header className="p-4 dark:bg-gray-100 dark:text-gray-800">
                <div className="container flex justify-between h-16 mx-auto">
                    ...
                    <div className="flex items-center md:space-x-4">
                        ...
                        {localStorage.getItem('token') ? <button className="hidden cursor-pointer px-6 py-2 font-semibold rounded lg:block dark:bg-rose-600 dark:text-gray-50" fdprocessedid="83yogu" onClick={logoutfun}>Log Out</button> : <Link to="/login" className="hidden px-6 py-2 font-semibold rounded lg:block dark:bg-rose-600 dark:text-gray-50" fdprocessedid="83yogu">Log in</Link>}
