...
const contact =(req,res)=>{
    ...
    const contact = new Contact({name, email,subject, massage});
    contact.save()
    .then(()=>{
            ...
            <html lang="en">
                ...
                <body>
                    <div class="container">
                        ...
                        <p>prabhat is made from the pain of writing all the
                        ...
                        <div class="footer">
                            <p style="text-align: center;">© 2024 prabhat. All rights
                                reserved.</p>
                        </div>
                    </div>
                </body>
