                        ...
                        <form className="p-6 flex flex-col justify-center">
                            <div className="flex flex-col">
                                ...
                                <input
                                    ...
                                    className="w-full mt-2 py-3 px-3 rounded-lg bg-white border border-gray-400 text-gray-800 font-semibold focus:border-rose-500 focus:outline-none"
                                />
                            </div>
                            ...
                            <button
                                type="submit"
                                className="md:w-32 bg-orange-600 hover:bg-blue-dark text-white font-bold py-3 px-6 rounded-lg mt-5 hover:bg-rose-600 transition ease-in-out duration-300"
                            >
                                Submit
                            </button>
                        </form>
