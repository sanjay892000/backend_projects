...
function Sidebar({ toggleDrawer, auth, logoutFun, navigate }) {
    return (
        <div className="bg-gray-100 dark:bg-gray-700 h-screen w-[250px] relative" role="presentation" onClick={toggleDrawer(false)}>
            ...
            <ul className="space-y-2 py-4 ">
                ...
                <li className='text-center absolute bottom-4 left-0 right-0'><Link to="/login" className="inline-block py-3 px-7 mt-10 font-semibold rounded-sm text-sm bg-gray-200 dark:bg-gray-800 text-gray-700 hover:bg-gray-300 dark:text-gray-200 dark:hover:bg-gray-900"
                    onClick={() => {
                        logoutFun();
                        navigate('/');
                    }
